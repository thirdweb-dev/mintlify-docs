...
<Card title="New Card" href="https://ai-sdk.dev/docs/introduction" cta="Learn more about the Vercel AI SDK">
  Vercel AI SDK is an open-source toolkit for building AI-powered applications with React and Next.js. It provides utilities like `useChat` and `useCompletion` to easily stream model responses, handle conversations, and integrate AI features into your app’s UI.
</Card>
...
<Tabs>
  <Tab title="Client-Side Integration">
  ...
  <Tab title="Server-Side Integration">
