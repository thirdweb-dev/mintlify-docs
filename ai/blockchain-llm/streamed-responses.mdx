...
description: "Learn how to handle streamed responses from thirdweb AI"
---
...
<Expandable title="Example of an SSE Stream:">
  ```json
  event: init
  data: {
...
<Tabs>
  <Tab title="TypeScript">
    Use the `fetch-event-stream` package in TypeScript to manage event streams. It provides a straightforward interface for handling and processing different event types.
